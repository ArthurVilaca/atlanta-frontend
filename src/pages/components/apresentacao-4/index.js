...
class Apresentecao4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default withRouter(Apresentecao4)